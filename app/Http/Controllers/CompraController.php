...
class CompraController extends Controller
{
    ...
    private function validated(Request $request): array { return $request->validate(['titulo'=>['nullable','string','max:100'],'unidade'=>['nullable',Rule::in(['lts','kg','un'])],'quantidade'=>['nullable','numeric','min:0'],'quantidade_unitaria'=>['nullable','numeric','min:0'],'comprador'=>['nullable','string','max:50'],'preco'=>['nullable','numeric','min:0'],'data_compra'=>['nullable','date'],'disponivel'=>['nullable','boolean']]); }
